"""Triage route — curated action queue (KEV ∪ EPSS≥0.5 ∪ critical-with-PoC)."""
...
def triage():
    ...
    try:
        with db_connect() as conn:
            ...
            rows = _rows_to_dicts(conn.execute(f"""
                ...
                LIMIT ? OFFSET ?
            """, (PER_PAGE_DEFAULT, offset)).fetchall())
    ...
    return page(
        "list.html",
        title="Triage queue", active="triage",
